...
func TestFromChannel(tt *testing.T) {
	...
	tt.Run("str", func(t *testing.T) {
		...
		if e, a := ([]string)(nil), slices.FromChannel[string](nil); !equal(a, e) {
		...
		if e, a := []string{"foo", "bar"}, slices.FromChannel(ch); !equal(a, e) {
			t.Errorf("expected `%#v`, found `%#v`", e, a)
		}
	})
	...
	tt.Run("int", func(t *testing.T) {
		// FromChannel(nil) gives nil
		if e, a := ([]int)(nil), slices.FromChannel[int](nil); !equal(a, e) {
			t.Errorf("expected `%#v`, found `%#v`", e, a)
		}
		...
		if e, a := []int{123, 456}, slices.FromChannel(ch); !equal(a, e) {
			t.Errorf("expected `%#v`, found `%#v`", e, a)
		}
	})
	...
	tt.Run("bool", func(t *testing.T) {
		// FromChannel(nil) gives nil
		if e, a := ([]bool)(nil), slices.FromChannel[bool](nil); !equal(a, e) {
			t.Errorf("expected `%#v`, found `%#v`", e, a)
		}
		...
		if e, a := []bool{true, false}, slices.FromChannel(ch); !equal(a, e) {
			t.Errorf("expected `%#v`, found `%#v`", e, a)
		}
	})
}
...
func TestToChannel(tt *testing.T) {
	...
	tt.Run("str", func(t *testing.T) {
		...
		ss = []string{"foo", "bar"}
		if e, a := ss, slices.FromChannel(slices.ToChannel(ss, 0)); !equal(a, e) {
			t.Errorf("expected `%#v`, found `%#v`", e, a)
		}
	})
