...
func TestUnique(tt *testing.T) {
	...
	tt.Run("str", func(t *testing.T) {
		...
		test := func(input, expected []string) {
			...
			if actual := slices.Unique(input); !equal(actual, expected) || same(actual, input) {
				t.Errorf("Unique(`%#v`)=`%#v`, expected `%#v`", input, actual, expected)
			}
			if actual := slices.UniqueBy(func(v string) string { return v }, input); !equal(actual, expected) || same(actual, input) {
				t.Errorf("UniqueBy(`%#v`)=`%#v`, expected `%#v`", input, actual, expected)
			}

			input2 := slices.Clone(input)
			if actual := slices.UniqueInPlace(input2); !equal(actual, expected) {
				t.Errorf("UniqueInPlace(`%#v`)=`%#v`, expected `%#v`", input, actual, expected)
			} else if len(actual) > 0 && !same(actual, input2) {
				t.Errorf("UniqueInPlace(`%#v`)=`%#v`, expected `%#v`", input, actual, expected)
			}

			input3 := slices.Clone(input)
			if actual := slices.UniqueInPlaceBy(func(v string) string { return v }, input3); !equal(actual, expected) {
	...
	tt.Run("int", func(t *testing.T) {
		...
		test := func(input, expected []int) {
			...
			if actual := slices.UniqueBy(func(v int) int { return v }, input); !equal(actual, expected) || same(actual, input) {
				t.Errorf("UniqueBy(`%#v`)=`%#v`, expected `%#v`", input, actual, expected)
			}
			...
			input3 := slices.Clone(input)
			if actual := slices.UniqueInPlaceBy(func(v int) int { return v }, input3); !equal(actual, expected) {
				t.Errorf("UniqueInPlaceBy(`%#v`)=`%#v`, expected `%#v`", input, actual, expected)
			} else if len(actual) > 0 && !same(actual, input3) {
				t.Errorf("UniqueInPlaceBy(`%#v`)=`%#v`, expected `%#v`", input, actual, expected)
			}
	...
	tt.Run("struct", func(t *testing.T) {
		...
		testBy := func(input, expected []User) {
			...
			if actual := slices.UniqueBy(byName, input); !equal(actual, expected) || same(actual, input) {
				t.Errorf("UniqueBy(`%#v`)=`%#v`, expected `%#v`", input, actual, expected)
			}

			input2 := slices.Clone(input)
			if actual := slices.UniqueInPlaceBy(byName, input2); !equal(actual, expected) {
				t.Errorf("UniqueInPlaceBy(`%#v`)=`%#v`, expected `%#v`", input, actual, expected)
			} else if len(actual) > 0 && !same(actual, input2) {
				t.Errorf("UniqueInPlaceBy(`%#v`)=`%#v`, expected `%#v`", input, actual, expected)
			}
